    ...
    return [
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "content": {"type": "string", "description": "Task content in markdown"},
                    "status": {
                        "type": "string",
        ...
        Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {
                    "path": {"type": "string", "description": "Relative path to the task"},
                    "project": {
                        "type": "string",
                        "description": "Project name to scope the task (optional)",
                    },
...
async def call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent]:
    ...
    try:
        if name == "create_task":
            ...
            return [
                TextContent(
                    type="text", text=f"✓ Created task '{result['title']}' at {result['path']}"
                )
            ]
            ...
            if not task:
                return [TextContent(type="text", text=f"✗ Task not found: {arguments['path']}")]
            ...
            return [TextContent(type="text", text=f"✓ Updated task: {result['path']}")]
            ...
            try:
                success = task_manager.delete_task(
                    arguments["path"], project=arguments.get("project")
                )
            except ValueError as e:
                return [TextContent(type="text", text=project_resolution_error_msg(e))]
            ...
            try:
                structure = task_manager.get_structure(
                    arguments.get("subpath", ""), project=arguments.get("project")
                )
            except ValueError as e:
                return [TextContent(type="text", text=project_resolution_error_msg(e))]
            ...
            try:
                success = task_manager.move_task(
                    arguments["old_path"], arguments["new_path"], project=arguments.get("project")
                )
            except ValueError as e:
                return [TextContent(type="text", text=project_resolution_error_msg(e))]
            ...
            return [
                TextContent(
                    type="text", text=f"✓ Moved task" if success else "✗ Failed to move task"
                )
            ]
